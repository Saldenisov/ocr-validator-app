...
\midrule
81 & Hexamethylbenzene & \ce{O^{.-} + C6(CH3)6 -> OH^- + C6(CH3)5(C^{\cdot}H2)} & 13 & $\sim 2.5 \times 10^9$ & p.r.; P.b.k. at 270 nm in \textbackslash\{\}\ce{N2O\}-satd. soln. contg. 0.5 mol L$^{-1}$ NaOH. & 751009 \\
\bottomrule
\end{tabular}
